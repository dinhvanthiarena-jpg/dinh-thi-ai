...
exports.index = async (req, res) => {
  ...
  res.render('home', {
    title: 'Đào tạo AI cho người đi làm - Vietpro',
    description:
      'Đinh Thi Ai đào tạo AI thực chiến cho người đi làm, doanh nghiệp, giáo viên, công chức và lãnh đạo: Prompt Engineering, Generative AI, triển khai AI.',
    structuredData: {
