  ...
  { id:5, cap:"th", title:"Lớp 5",
    ...
    chapters:[
      { title:"Đất nước và con người Việt Nam", scope:"vn", nodes:[
        {id:"g5-0-0", title:"Vị trí địa lí, lãnh thổ, Quốc kì, Quốc ca"},
        {id:"g5-0-1", title:"Thiên nhiên Việt Nam"},
        {id:"g5-0-2", title:"Biển, đảo Việt Nam"},
  ...
  { id:6, cap:"thcs", title:"Lớp 6",
    ...
    chapters:[
      ...
      { title:"Xã hội nguyên thuỷ", scope:"tg", nodes:[
        {id:"g6-1-0", title:"Nguồn gốc loài người"},
        {id:"g6-1-1", title:"Xã hội nguyên thuỷ"},
        {id:"g6-1-2", title:"Sự chuyển biến và phân hoá của xã hội nguyên thuỷ"},
        {id:"g6-1-3", title:"Ôn tập", review:true},
      ]},
      { title:"Xã hội cổ đại", scope:"tg", nodes:[
        {id:"g6-2-0", title:"Ai Cập và Lưỡng Hà cổ đại"},
        {id:"g6-2-1", title:"Ấn Độ cổ đại"},
        {id:"g6-2-2", title:"Trung Quốc từ thời cổ đại đến thế kỉ VII"},
        {id:"g6-2-3", title:"Hy Lạp và La Mã cổ đại"},
        {id:"g6-2-4", title:"Ôn tập", review:true},
      ]},
      { title:"Đông Nam Á (đầu Công nguyên đến thế kỉ X)", scope:"tg", nodes:[
        {id:"g6-3-0", title:"Các quốc gia sơ kì ở Đông Nam Á"},
        {id:"g6-3-1", title:"Các vương quốc phong kiến Đông Nam Á (TK VII–X)"},
        {id:"g6-3-2", title:"Giao lưu văn hoá ở Đông Nam Á"},
        {id:"g6-3-3", title:"Ôn tập", review:true},
      ]},
      { title:"Việt Nam từ khoảng TK VII TCN đến đầu TK X", scope:"vn", nodes:[
        {id:"g6-4-0", title:"Nhà nước Văn Lang, Âu Lạc"},
        {id:"g6-4-1", title:"Chính sách cai trị của phong kiến phương Bắc"},
        {id:"g6-4-2", title:"Các cuộc khởi nghĩa tiêu biểu trước thế kỉ X"},
        {id:"g6-4-3", title:"Đấu tranh bảo tồn văn hoá dân tộc"},
        {id:"g6-4-4", title:"Bước ngoặt lịch sử đầu thế kỉ X"},
        {id:"g6-4-5", title:"Vương quốc Chăm-pa (TK II–X)"},
  ...
  { id:7, cap:"thcs", title:"Lớp 7",
    ...
    chapters:[
      { title:"Tây Âu (TK V – nửa đầu TK XVI)", scope:"tg", nodes:[
        {id:"g7-0-0", title:"Quá trình hình thành chế độ phong kiến Tây Âu"},
        {id:"g7-0-1", title:"Phát kiến địa lí & CNTB Tây Âu"},
        {id:"g7-0-2", title:"Văn hoá Phục hưng & cải cách tôn giáo"},
      ]},
      { title:"Trung Quốc và Ấn Độ thời trung đại", scope:"tg", nodes:[
        {id:"g7-1-0", title:"Trung Quốc (TK VII – giữa TK XIX)"},
        {id:"g7-1-1", title:"Ấn Độ (TK IV – giữa TK XIX)"},
      ]},
      { title:"Đông Nam Á (nửa sau TK X – nửa đầu TK XVI)", scope:"tg", nodes:[
        {id:"g7-2-0", title:"Các vương quốc phong kiến Đông Nam Á"},
        {id:"g7-2-1", title:"Vương quốc Lào"},
  ...
  { id:8, cap:"thcs", title:"Lớp 8",
    ...
    chapters:[
      ...
      { title:"Chủ nghĩa đế quốc & phong trào công nhân", scope:"tg", nodes:[
        ...
        {id:"g8-1-1", title:"Phong trào công nhân & CNXH khoa học"},
        {id:"g8-1-2", title:"Chiến tranh thế giới thứ nhất & CM Tháng Mười Nga"},
      ]},
      { title:"Khoa học – kĩ thuật – văn hoá TK XVIII–XIX", scope:"tg", nodes:[
        {id:"g8-2-0", title:"Thành tựu khoa học, kĩ thuật, văn học, nghệ thuật"},
      ]},
      { title:"Châu Á & Việt Nam (nửa sau TK XIX – đầu TK XX)", scope:"both", nodes:[
        {id:"g8-3-0", title:"Châu Á trước làn sóng xâm lược phương Tây"},
        {id:"g8-3-1", title:"Việt Nam nửa cuối TK XIX — Pháp xâm lược, triều Nguyễn"},
        {id:"g8-3-2", title:"Phong trào Cần Vương & khởi nghĩa nông dân Yên Thế"},
        {id:"g8-3-3", title:"Việt Nam đầu TK XX — phong trào Đông Du, Duy Tân"},
      ]},
    ]},
  { id:9, cap:"thcs", title:"Lớp 9",
    ...
    chapters:[
      { title:"Nước Nga và Liên Xô (1918–1945)", scope:"tg", nodes:[
        {id:"g9-0-0", title:"Nước Nga sau Cách mạng tháng Mười"},
        {id:"g9-0-1", title:"Liên Xô xây dựng CNXH"},
      ]},
      { title:"Châu Âu, nước Mỹ và châu Á (1918–1945)", scope:"tg", nodes:[
        {id:"g9-1-0", title:"Châu Âu giữa hai cuộc chiến tranh"},
        {id:"g9-1-1", title:"Nước Mỹ giữa hai cuộc chiến tranh"},
        {id:"g9-1-2", title:"Châu Á giữa hai cuộc chiến tranh"},
      ]},
      ...
      { title:"Cách mạng khoa học – kĩ thuật & toàn cầu hoá", scope:"both", nodes:[
        {id:"g9-4-0", title:"Tác động tới thế giới và Việt Nam hiện nay"},
      ]},
      { title:"Chủ đề chung", scope:"vn", nodes:[
        {id:"g9-5-0", title:"Đô thị: Lịch sử và hiện tại"},
        {id:"g9-5-1", title:"Văn minh châu thổ sông Hồng và sông Cửu Long"},
        {id:"g9-5-2", title:"Bảo vệ chủ quyền của Việt Nam ở Biển Đông"},
      ]},
    ]},
  ...
  { id:12, cap:"thpt", title:"Lớp 12",
    ...
    chapters:[
      { title:"Thế giới sau Chiến tranh lạnh & ASEAN", scope:"both", nodes:[
        {id:"g12-0-0", title:"Trật tự thế giới sau Chiến tranh lạnh"},
        {id:"g12-0-1", title:"Sự ra đời và phát triển của ASEAN"},
      ...
      { title:"Công cuộc Đổi mới ở Việt Nam", scope:"vn", nodes:[
        ...
        {id:"g12-2-1", title:"Thành tựu & bài học của công cuộc Đổi mới"},
      ]},
      { title:"Đối ngoại Việt Nam thời cận – hiện đại", scope:"vn", nodes:[
        {id:"g12-3-0", title:"Đối ngoại trong đấu tranh giành độc lập (đầu TK XX – CMT8 1945)"},
        {id:"g12-3-1", title:"Đối ngoại trong kháng chiến chống Pháp & Mỹ"},
        {id:"g12-3-2", title:"Đối ngoại từ năm 1975 đến nay"},
      ]},
      { title:"Hồ Chí Minh trong lịch sử Việt Nam", scope:"vn", nodes:[
        {id:"g12-4-0", title:"Khái quát cuộc đời và sự nghiệp"},
        {id:"g12-4-1", title:"Hồ Chí Minh — Anh hùng giải phóng dân tộc"},
        {id:"g12-4-2", title:"Dấu ấn Hồ Chí Minh trong lòng nhân dân thế giới & Việt Nam"},
      ]},
    ]},
];
