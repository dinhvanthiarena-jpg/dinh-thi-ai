  ...
  { id:10, cap:"thpt", title:"Lớp 10",
    ...
    chapters:[
      { title:"Lịch sử và Sử học, vai trò của Sử học", scope:"both", nodes:[
        {id:"g10-0-0", title:"Hiện thực lịch sử và nhận thức lịch sử", authored:true},
        {id:"g10-0-1", title:"Tri thức lịch sử và cuộc sống", authored:true},
        {id:"g10-0-2", title:"Sử học với các lĩnh vực khoa học & ngành nghề hiện đại", authored:true},
      ]},
      { title:"Văn minh thế giới cổ – trung đại", scope:"tg", nodes:[
        {id:"g10-1-0", title:"Văn minh phương Đông cổ – trung đại", authored:true},
        {id:"g10-1-1", title:"Văn minh phương Tây cổ – trung đại", authored:true},
      ]},
      { title:"Các cuộc cách mạng công nghiệp", scope:"tg", nodes:[
        {id:"g10-2-0", title:"Cách mạng công nghiệp thời cận đại", authored:true},
        {id:"g10-2-1", title:"Cách mạng công nghiệp thời hiện đại", authored:true},
      ]},
      { title:"Văn minh Đông Nam Á", scope:"tg", nodes:[
        {id:"g10-3-0", title:"Cơ sở hình thành văn minh Đông Nam Á", authored:true},
        {id:"g10-3-1", title:"Hành trình phát triển & thành tựu", authored:true},
      ]},
      { title:"Văn minh Việt Nam (trước 1858) & cộng đồng dân tộc", scope:"vn", nodes:[
        {id:"g10-4-0", title:"Các nền văn minh cổ trên đất nước Việt Nam", authored:true},
        {id:"g10-4-1", title:"Văn minh Đại Việt", authored:true},
        {id:"g10-4-2", title:"Đời sống cộng đồng các dân tộc Việt Nam", authored:true},
      ]},
    ]},
  { id:11, cap:"thpt", title:"Lớp 11",
    ...
    chapters:[
      { title:"Cách mạng tư sản & chủ nghĩa xã hội", scope:"tg", nodes:[
        {id:"g11-0-0", title:"Một số vấn đề chung về cách mạng tư sản", authored:true},
        {id:"g11-0-1", title:"Sự xác lập chủ nghĩa tư bản", authored:true},
        {id:"g11-0-2", title:"Liên bang Cộng hoà XHCN Xô Viết", authored:true},
        {id:"g11-0-3", title:"Chủ nghĩa xã hội từ sau Chiến tranh thế giới thứ hai đến nay", authored:true},
      ]},
      { title:"Đông Nam Á giành độc lập", scope:"tg", nodes:[
        {id:"g11-1-0", title:"Quá trình xâm lược & cai trị của thực dân ở Đông Nam Á", authored:true},
        {id:"g11-1-1", title:"Hành trình đi đến độc lập dân tộc", authored:true},
      ]},
      { title:"Chiến tranh bảo vệ Tổ quốc (trước Cách mạng tháng Tám 1945)", scope:"vn", nodes:[
        {id:"g11-2-0", title:"Khái quát chiến tranh bảo vệ Tổ quốc trong lịch sử Việt Nam", authored:true},
        {id:"g11-2-1", title:"Một số cuộc khởi nghĩa & chiến tranh giải phóng", authored:true},
      ]},
      { title:"Các cuộc cải cách lớn trong lịch sử Việt Nam", scope:"vn", nodes:[
        {id:"g11-3-0", title:"Cải cách của Hồ Quý Ly & triều Hồ (đầu TK XV)", authored:true},
        {id:"g11-3-1", title:"Cải cách của Lê Thánh Tông (TK XV)", authored:true},
        {id:"g11-3-2", title:"Cải cách của Minh Mạng (nửa đầu TK XIX)", authored:true},
      ]},
      { title:"Làng xã Việt Nam & Biển Đông", scope:"vn", nodes:[
        {id:"g11-4-0", title:"Làng xã Việt Nam trong lịch sử", authored:true},
        {id:"g11-4-1", title:"Vị trí và tầm quan trọng của Biển Đông", authored:true},
        {id:"g11-4-2", title:"Việt Nam và Biển Đông", authored:true},
      ]},
    ]},
