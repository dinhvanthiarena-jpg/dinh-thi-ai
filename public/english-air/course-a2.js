    ...
    lessons: [
      {
        ...
        teach: [
          ...
          { t: "vocab", en: "yesterday", vi: "hôm qua", ipa: "/ˈjestərdeɪ/", note: "Không cần giới từ: I was busy yesterday.", ex: { en: "I was at home yesterday.", vi: "Hôm qua tôi ở nhà." } },
          { t: "vocab", en: "last", vi: "vừa rồi, trước", ipa: "/læst/", note: "last week, last month, last year — đều không cần giới từ.", ex: { en: "We were in Hue last week.", vi: "Tuần trước chúng tôi ở Huế." } },
          { t: "vocab", en: "ago", vi: "cách đây", ipa: "/əˈɡoʊ/", note: "Đứng SAU khoảng thời gian: two days ago, chứ không phải ago two days.", ex: { en: "She was here two hours ago.", vi: "Cô ấy ở đây cách đây hai tiếng." } },
          { t: "vocab", en: "busy", vi: "bận", ipa: "/ˈbɪzi/", note: "Đọc là /ˈbɪ-zi/, chữ u không đọc thành “biu”.", ex: { en: "I was very busy last week.", vi: "Tuần trước tôi rất bận." } },
          { t: "vocab", en: "free", vi: "rảnh, miễn phí", ipa: "/friː/", note: "Hai nghĩa: rảnh rỗi và miễn phí. Hiểu theo ngữ cảnh.", ex: { en: "Were you free yesterday?", vi: "Hôm qua bạn có rảnh không?" } },
          { t: "vocab", en: "born", vi: "sinh ra", ipa: "/bɔːrn/", note: "Luôn dùng bị động: I was born in 1990. Không bao giờ nói I born.", ex: { en: "He was born in Hanoi.", vi: "Anh ấy sinh ra ở Hà Nội." } },
...

      {
        ...
        teach: [
          ...
          { t: "vocab", en: "visit", vi: "thăm", ipa: "/ˈvɪzɪt/", note: "Có quy tắc: visited.", ex: { en: "I visited my parents.", vi: "Tôi đã về thăm bố mẹ." } },
          { t: "vocab", en: "travel", vi: "đi du lịch", ipa: "/ˈtrævl/", note: "Anh–Anh viết travelled, Anh–Mỹ viết traveled.", ex: { en: "We travelled to Hue.", vi: "Chúng tôi đã đi Huế." } },
          { t: "vocab", en: "watch", vi: "xem", ipa: "/wɑːtʃ/", note: "watch dùng cho phim, TV. see dùng cho nhìn thấy.", ex: { en: "I watched a film last night.", vi: "Tối qua tôi đã xem một bộ phim." } },
          { t: "vocab", en: "meet", vi: "gặp", ipa: "/miːt/", note: "Bất quy tắc: met.", ex: { en: "I met my friend yesterday.", vi: "Hôm qua tôi đã gặp bạn tôi." } },
          { t: "vocab", en: "buy", vi: "mua", ipa: "/baɪ/", note: "Bất quy tắc: bought /bɔːt/.", ex: { en: "She bought a new phone.", vi: "Cô ấy đã mua một chiếc điện thoại mới." } },
    ...
    lessons: [
      {
        ...
        teach: [
          ...
          { t: "vocab", en: "plan", vi: "kế hoạch, dự định", ipa: "/plæn/", note: "Vừa danh từ vừa động từ: I plan to go.", ex: { en: "What is your plan for tomorrow?", vi: "Kế hoạch ngày mai của bạn là gì?" } },
          { t: "vocab", en: "weekend", vi: "cuối tuần", ipa: "/ˈwiːkend/", note: "Anh–Anh nói at the weekend, Anh–Mỹ nói on the weekend.", ex: { en: "I am going to rest this weekend.", vi: "Cuối tuần này tôi định nghỉ ngơi." } },
          { t: "vocab", en: "holiday", vi: "kỳ nghỉ", ipa: "/ˈhɑːlədeɪ/", note: "Anh–Mỹ thường nói vacation.", ex: { en: "We are going to Da Nang on holiday.", vi: "Chúng tôi sẽ đi Đà Nẵng nghỉ mát." } },
          { t: "vocab", en: "ticket", vi: "vé", ipa: "/ˈtɪkɪt/", note: "Vé máy bay là a plane ticket.", ex: { en: "I bought two tickets.", vi: "Tôi đã mua hai vé." } },
          { t: "vocab", en: "airport", vi: "sân bay", ipa: "/ˈerpɔːrt/", note: "Ra sân bay: go to the airport, có the.", ex: { en: "We are going to the airport at six.", vi: "Sáu giờ chúng tôi ra sân bay." } },
          { t: "vocab", en: "tonight", vi: "tối nay", ipa: "/təˈnaɪt/", note: "Không cần giới từ, giống today và tomorrow.", ex: { en: "I am going to study tonight.", vi: "Tối nay tôi định học bài." } },
...

      {
        ...
        teach: [
          ...
          { t: "phrase", en: "Are you free on Sunday?", vi: "Chủ nhật bạn có rảnh không?", ipa: "/ɑːr juː friː ɑːn ˈsʌndeɪ/", note: "Cách mở lời tự nhiên nhất. Nhớ dùng on với thứ trong tuần." },
          { t: "phrase", en: "Let's meet at six", vi: "Gặp nhau lúc sáu giờ nhé", ipa: "/lets miːt æt sɪks/", note: "Let's = let us. Sau let's luôn là động từ nguyên thể." },
          { t: "phrase", en: "I'm sorry, I can't", vi: "Xin lỗi, tôi không đi được", ipa: "/aɪm ˈsɑːri aɪ kænt/", note: "Từ chối chuẩn: xin lỗi trước, rồi mới nêu lý do." },
          { t: "vocab", en: "meeting", vi: "cuộc họp", ipa: "/ˈmiːtɪŋ/", note: "Có cuộc họp nói have a meeting.", ex: { en: "I have a meeting at ten.", vi: "Tôi có cuộc họp lúc mười giờ." } },
          { t: "vocab", en: "later", vi: "lát nữa, muộn hơn", ipa: "/ˈleɪtər/", note: "See you later là câu chia tay rất thông dụng.", ex: { en: "Can we meet later?", vi: "Lát nữa gặp nhau được không?" } },
          { t: "vocab", en: "together", vi: "cùng nhau", ipa: "/təˈɡeðər/", note: "Đứng cuối câu: We study together.", ex: { en: "Let's have lunch together.", vi: "Ăn trưa cùng nhau nhé." } },
          { t: "vocab", en: "wait", vi: "chờ", ipa: "/weɪt/", note: "Chờ ai đó thì phải có for: wait for me.", ex: { en: "Please wait for me.", vi: "Làm ơn chờ tôi với." } },
          { t: "vocab", en: "phone", vi: "gọi điện, điện thoại", ipa: "/foʊn/", pic: "phone", note: "Vừa danh từ vừa động từ: I'll phone you.", ex: { en: "I will phone you tonight.", vi: "Tối nay tôi sẽ gọi cho bạn." } },
