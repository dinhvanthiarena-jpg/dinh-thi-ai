...
const tool = {
  title: 'ON-Language — Học ngoại ngữ',
  category: 'Ứng dụng',
  shortDescription:
  ...
  description:
    'ON-Language dạy ngoại ngữ theo cách của một người thầy chứ không phải một trò chơi: mỗi bài đều đi qua các slide dạy — từ mới có phiên âm, ghi chú và ví dụ, bảng ngữ pháp, góc văn hoá, hội thoại mẫu — rồi mới tới phần câu hỏi.\n\n' +
    ...
    'Đặc biệt có màn gọi video với ON-Language — linh vật đứng trong phòng học, cử động và mấp máy miệng theo lời nói. Nói chuyện tự do với nó bằng tiếng Việt, tiếng Anh hay tiếng Trung đều được: bạn nói tiếng nào, nó tự nhận ra và đáp lại đúng tiếng đó, không phải chọn trước.\n\n' +
