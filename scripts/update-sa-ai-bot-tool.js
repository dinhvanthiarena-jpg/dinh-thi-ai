...
// Cập nhật lại mô tả (đúng bản thầy Đinh Thi Ai gửi 2026-09-24) + thêm ảnh
// trưng bày cho Tool id 6 (SA-AI BOT) trong Kho tài nguyên. Xem
// scripts/create-sa-ai-bot-tool.js cho bối cảnh tạo ban đầu.
async function run() {
  await connectDB();
...
Sở hữu SA-AI BOT ngay hôm nay — 1 lần cài đặt, chạy mãi mãi.`,
    galleryImages: [
      '/images/tools/sa-ai-bot-overview.png',
      '/images/tools/sa-ai-bot-zalo-auto.png',
      '/images/tools/sa-ai-bot-mascot.jpg',
    ],
  });
  await tool.save();

  console.log('Đã cập nhật:', tool.id, tool.slug);
  process.exit(0);
}
