...
// Thầy Đinh Thi Ai yêu cầu 2026-09-24: bỏ đoạn "💰 Không chỉ chạy quảng cáo —
// còn biết tiền lời thật là bao nhiêu" (Lợi nhuận thật/CRM) khỏi bài giới
// thiệu SA-AI BOT.
...
Sở hữu SA-AI BOT ngay hôm nay — 1 lần cài đặt, chạy mãi mãi.`,
  ...
  console.log('Đã bỏ đoạn lợi nhuận/CRM:', tool.id, tool.slug);
  process.exit(0);
}
